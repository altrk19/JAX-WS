...
public class MemoryData {
	...
	public static List<Order> orders = new ArrayList<>();        //liste tanýmladýk asagida array dönüyoruz

	static {
		Calendar calendar = Calendar.getInstance();

		calendar.set(2018, 11, 21, 20, 30, 40);
		Date date1 = calendar.getTime();

		calendar.set(2018, 11, 20, 21, 35, 45);
		Date date2 = calendar.getTime();

		calendar.set(2018, 11, 15, 23, 20, 50);
