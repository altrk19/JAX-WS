...
public class TestClient {
	...
	public static void main(String[] args) throws MalformedURLException, OrderWSException {
		...
		//trace soap message    (soap mesajlarýný -> response mesajalrýný console'a yazdýrdýk)
		System.setProperty("com.sun.xml.internal.ws.transport.http.client.HttpTransportPipe.dump", "true");
		
		URL url = new URL("http://localhost:8080/myService/orderws?wsdl");
		...
		//headerlar map<string,List<String>> ....  mantýgýnda tutuluyor
		
		Map<String, List<String>> requestHeaders = new HashMap<>();
		//
		requestHeaders.put("username", Arrays.asList("admin"));
		requestHeaders.put("password", Arrays.asList("12345"));
		//requestHeaders.put("password", Arrays.asList("123456"));             //EXCEPTION
